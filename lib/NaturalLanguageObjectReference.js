      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          return _this.extractCustomerName(_this.query).then(function(match) {
            var c, child, e, error1, formattedSuggestions, i, j, keywords, len, len1, m, matches, potentiallyIntendedTarget, potentiallyIntendedTargets, property, query, ref, suggestions, target;
            matches = [match];
            try {
              while (match.query) {
                query = match.query;
      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          return _this.Customer.getAllNameRegexString().then(function(customerRegexString) {
            var e, error1, i, len, m, regex, regexs;
